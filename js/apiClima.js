...
const apiClima = {
    async consultaClima() {
        try {            
            clima = await api.buscarDados(endpoint);
            return clima;
        } catch (error) {
...
// Exemplo de uso:
//const configuracoesClima = (await apiClima.consultaClima())[0];
//const climaAtual = await apiClima.obterClima(configuracoesClima);
//console.log(configuracoesClima);
